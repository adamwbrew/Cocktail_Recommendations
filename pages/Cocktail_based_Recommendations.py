...
layout = html.Div(children=[
    html.H1(children='Cocktail Based Recommendations', style={'textAlign': 'center', 'font-size': '50px', 'text-decoration': 'underline', 'margin-bottom':25, 'margin-top':25}),
    ...
    html.Div([
        ...
        html.Div([dbc.Button("Click me", id="dropdown-state-example-button", color="info", className="me-1", n_clicks=0)]),
